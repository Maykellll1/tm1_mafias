local ped = {name = "El manda trabajo", x=-257.96, y=6247.2, z= 30.48,rotation = 330.01,NetworkSync = true}
local changed = {name = "El cambia trabajo", x = -179.48, y = 6262.4,z = 30.52,rotation = 330.01,NetworkSync = true}
local seller = {name = "El vende trabajo", x = -365.12, y = 6337.32,z = 28.84,rotation = 240.01,NetworkSync = true}
local truckspawn = {x = -262.44, y = 6254.72,z = 31.44}
local cerrajero = {x = -2174.6, y = 4273.08,z = 48.0}
local truckDown = {x = -256.36, y = 6250.0,z = 30.48}
local priceScope = 35
local priceCanion = 35
local priceCulett = 30
local isInJob = false
